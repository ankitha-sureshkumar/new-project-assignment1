...
class DashboardController {
    constructor() {
        ...
        this.dashboardServiceUser = new StrategyPattern_1.DashboardService(new StrategyPattern_1.PetParentDashboardStrategy());
        this.dashboardServiceVet = new StrategyPattern_1.DashboardService(new StrategyPattern_1.VeterinarianDashboardStrategy());
    }
