...
router.get('/user/:userId', AppointmentController_1.default.getUserAppointments.bind(AppointmentController_1.default));
router.get('/veterinarian/:vetId', AppointmentController_1.default.getVetAppointments.bind(AppointmentController_1.default));
router.get('/availability/:vetId', AppointmentController_1.default.getAvailableSlots.bind(AppointmentController_1.default));
router.get('/pet/:petId', AppointmentController_1.default.getPetAppointments.bind(AppointmentController_1.default));
router.get('/today/schedule', (0, auth_1.authorize)('veterinarian', 'admin'), AppointmentController_1.default.getTodaysSchedule.bind(AppointmentController_1.default));
router.get('/upcoming/reminders', (0, auth_1.authorize)('admin'), AppointmentController_1.default.getUpcomingReminders.bind(AppointmentController_1.default));
